...
# Looking for Patterns in State Capitals
...
- [Instructor's Guide: Memorizing State Capitals](../../instructors-guide/memorizing-state-capitals.md) - A critical analysis of memorization vs. pattern-based learning
